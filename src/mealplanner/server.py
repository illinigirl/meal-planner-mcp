...
def plan_week(days: int = 7, household_size: int = 4, start_date: str | None = None,
              ...
              max_time: int | None = None, avoid_recent_days: int = 14) -> dict:
    ...
    Saves as the current plan (so generate_shopping_list / export_plan use it).
    """
...
def add_recipe(title: str, ingredients: list[str], servings: int = 4,
               ...
               cuisine: str | None = None, directions: str | None = None) -> dict:
